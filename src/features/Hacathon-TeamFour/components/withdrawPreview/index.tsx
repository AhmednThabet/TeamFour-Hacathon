...
export const WithdraWPrevieW = ({ handleConfirm }: any) => {
  console.log(handleConfirm);

  return (
    <div className=" flex flex-col items-center w-[500px] relative p-10 ">
      ...
      <div>
        ...
        <div>transferred components</div>
        <div className=" border-2 flex flex-col p-5 rounded-md">
